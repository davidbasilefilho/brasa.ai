...
export const accents = {
	emerald: {
		...
		text: "text-black",
		mutedBg: "bg-[color-mix(in_oklab,varaccent-green_15%,transparent)]",
		mutedText: "text-[color-mix(in_oklab,varaccent-green_70%,white)]",
		mutedBorder: "border-[color-mix(in_oklab,varaccent-green_30%,transparent)]",
	...
	blue: {
		...
		text: "text-black",
		mutedBg: "bg-[color-mix(in_oklab,varaccent-blue_15%,transparent)]",
		mutedText: "text-[color-mix(in_oklab,varaccent-blue_70%,white)]",
		mutedBorder: "border-[color-mix(in_oklab,varaccent-blue_30%,transparent)]",
	...
	yellow: {
		...
		text: "text-black",
		mutedBg: "bg-[color-mix(in_oklab,varaccent-yellow_10%,transparent)]",
		mutedText: "text-[color-mix(in_oklab,varaccent-yellow_70%,black)]",
		mutedBorder:
			"border-[color-mix(in_oklab,varaccent-yellow_40%,transparent)]",
	...
	indigo: {
		...
		text: "text-black",
		mutedBg: "bg-[color-mix(in_oklab,varaccent-indigo_15%,transparent)]",
		mutedText: "text-[color-mix(in_oklab,varaccent-indigo_70%,white)]",
		mutedBorder:
			"border-[color-mix(in_oklab,varaccent-indigo_30%,transparent)]",
